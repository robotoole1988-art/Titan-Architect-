...
/**
 * How the work is actually delivered — and therefore what the customer is
 * buying (ADR-065).
 *
 * `"platform"` — TITAN's code produces the artefact. The website engine and
 * the Google Ads plan generator are the only two things that qualify.
 *
 * `"hand"` — a person does the work. Nothing is automated; the platform may
 * not touch it at all. GBP, Local Services Ads, Meta and AI-search visibility
 * are all this, and every one of them was described in this catalogue as
 * though the platform ran it.
 *
 * The distinction is a field rather than a turn of phrase in `description`
 * because it has to be enforceable. A price list that implies automation the
 * company does not have is a misrepresentation in a contract, which is a
 * worse version of the exact thing ADR-059's honesty law exists to stop on a
 * customer's website — and a description is one careless edit from drifting.
 * `tests/core/pricing-honesty.test.ts` pins each service to its truth.
 */
export type ServiceDelivery = "platform" | "hand";

export interface PricedService {
  id: PricedServiceId;
  label: string;
  description: string;
  /** Code, or a person. Never guessed from the description. */
...
export const PRICING_CATALOGUE: ReadonlyArray<PricedService> = [
  {
    ...
    description:
      "The flagship: a cinematic landing experience and a Google Ads campaign built from your trade's real cost-per-lead. TITAN generates the site and the full campaign; the campaign is launched and managed in your own Google Ads account by hand.",
    delivery: "platform",
  ...
  },
  {
    id: "website_build",
    label: "Website Build",
    description: "Full cinematic website, generated by the TITAN blueprint pipeline and reviewed before it goes live.",
    delivery: "platform",
  ...
  },
  {
    ...
    description: "Ongoing local SEO worked by hand — content, technical health and rankings. The on-page foundations (structure, metadata, schema, sitemap, area pages) are built by the platform with the site.",
    delivery: "hand",
    recommendedSetupFee: 495,
  ...
  },
  {
    ...
    description: "Your Google Business Profile, managed personally: posts, review responses, Q&A and photos. Done by hand, not automated.",
    delivery: "hand",
  ...
  },
  {
    ...
    description: "Google Local Services Ads set up and worked by hand: profile and licensing, lead review and disputes, budget pacing.",
    delivery: "hand",
    recommendedSetupFee: 295,
  ...
  },
  {
    ...
    description: "Facebook and Instagram demand generation and retargeting, built and managed by hand in your own ad account.",
    delivery: "hand",
    recommendedSetupFee: 495,
    recommendedMonthlyFee: 295,
  },
  {
    ...
    description: "Getting your business named when customers ask an AI assistant. Hands-on work — structured data, source presence and citation checks — reviewed each month.",
    delivery: "hand",
  ...
  // ---- Bundle tiers: priced BELOW the sum of parts, by design. ----
  {
    ...
    label: "Launch",
    description:
      "Get live and getting leads: cinematic site + Google Ads lead generation + your Google Business Profile managed for you.",
    delivery: "platform",
  ...
  },
  {
    ...
    label: "Dominate",
    description:
      "Own the local map and the rankings: Launch + SEO + Local Services Ads + area landing pages.",
    delivery: "platform",
  ...
  },
  {
    ...
    label: "TITAN",
    description:
      "Everything, everywhere they search: Dominate + Meta Ads + AI Search. The website and the Google Ads build are generated by the platform; the profile, Local Services, Meta and AI-search work is delivered by hand.",
    delivery: "platform",
