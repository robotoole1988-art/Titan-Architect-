...
| **Experience Strategy** | `src/core/experience-strategy/` | The first engine that produces real value: generates a structured Experience Strategy document from a business's details. v0.1 uses mock data (no AI/UI); designed for the Brain to drive later. See the module `README`. |
